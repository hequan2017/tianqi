...
func (i *initCasbin) InitializeData(ctx context.Context) (context.Context, error) {
	...
	entities := []adapter.CasbinRule{
		...
		// 仪表盘相关权限
		{Ptype: "p", V0: "888", V1: "/dashboard/stats", V2: "GET"},

		// 模型训练相关权限 - 数据集管理
		{Ptype: "p", V0: "888", V1: "/modeltraining/dataset/createDataset", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/modeltraining/dataset/deleteDataset", V2: "DELETE"},
		{Ptype: "p", V0: "888", V1: "/modeltraining/dataset/deleteDatasetByIds", V2: "DELETE"},
		{Ptype: "p", V0: "888", V1: "/modeltraining/dataset/updateDataset", V2: "PUT"},
		{Ptype: "p", V0: "888", V1: "/modeltraining/dataset/findDataset", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/modeltraining/dataset/getDatasetList", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/modeltraining/dataset/getDatasetDataSource", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/modeltraining/dataset/createVersion", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/modeltraining/dataset/deleteVersion", V2: "DELETE"},
		{Ptype: "p", V0: "888", V1: "/modeltraining/dataset/getVersionList", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/modeltraining/dataset/publishDataset", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/modeltraining/dataset/uploadFile", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/modeltraining/dataset/uploadVersionFile", V2: "POST"},

		// 模型训练相关权限 - 训练任务
		{Ptype: "p", V0: "888", V1: "/modeltraining/trainingTask/createTask", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/modeltraining/trainingTask/deleteTask", V2: "DELETE"},
		{Ptype: "p", V0: "888", V1: "/modeltraining/trainingTask/deleteTaskByIds", V2: "DELETE"},
		{Ptype: "p", V0: "888", V1: "/modeltraining/trainingTask/updateTask", V2: "PUT"},
		{Ptype: "p", V0: "888", V1: "/modeltraining/trainingTask/findTask", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/modeltraining/trainingTask/getTaskList", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/modeltraining/trainingTask/startTask", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/modeltraining/trainingTask/stopTask", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/modeltraining/trainingTask/markCompleted", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/modeltraining/trainingTask/startService", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/modeltraining/trainingTask/stopService", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/modeltraining/trainingTask/chatCompletion", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/modeltraining/trainingTask/getTaskLogs", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/modeltraining/trainingTask/getTaskDataSource", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/modeltraining/trainingTask/getDefaultParams", V2: "GET"},

		// 模型测试历史权限
		{Ptype: "p", V0: "888", V1: "/modeltraining/modelTest/createTestHistory", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/modeltraining/modelTest/deleteTestHistory", V2: "DELETE"},
		{Ptype: "p", V0: "888", V1: "/modeltraining/modelTest/clearTestHistory", V2: "DELETE"},
		{Ptype: "p", V0: "888", V1: "/modeltraining/modelTest/getTestHistoryList", V2: "GET"},
		...
		// 仪表盘相关权限
		{Ptype: "p", V0: "9528", V1: "/dashboard/stats", V2: "GET"},

		// 模型训练相关权限 - 数据集管理 (9528)
		{Ptype: "p", V0: "9528", V1: "/modeltraining/dataset/createDataset", V2: "POST"},
		{Ptype: "p", V0: "9528", V1: "/modeltraining/dataset/deleteDataset", V2: "DELETE"},
		{Ptype: "p", V0: "9528", V1: "/modeltraining/dataset/deleteDatasetByIds", V2: "DELETE"},
		{Ptype: "p", V0: "9528", V1: "/modeltraining/dataset/updateDataset", V2: "PUT"},
		{Ptype: "p", V0: "9528", V1: "/modeltraining/dataset/findDataset", V2: "GET"},
		{Ptype: "p", V0: "9528", V1: "/modeltraining/dataset/getDatasetList", V2: "GET"},
		{Ptype: "p", V0: "9528", V1: "/modeltraining/dataset/getDatasetDataSource", V2: "GET"},
		{Ptype: "p", V0: "9528", V1: "/modeltraining/dataset/createVersion", V2: "POST"},
		{Ptype: "p", V0: "9528", V1: "/modeltraining/dataset/deleteVersion", V2: "DELETE"},
		{Ptype: "p", V0: "9528", V1: "/modeltraining/dataset/getVersionList", V2: "GET"},
		{Ptype: "p", V0: "9528", V1: "/modeltraining/dataset/publishDataset", V2: "POST"},
		{Ptype: "p", V0: "9528", V1: "/modeltraining/dataset/uploadFile", V2: "POST"},
		{Ptype: "p", V0: "9528", V1: "/modeltraining/dataset/uploadVersionFile", V2: "POST"},

		// 模型训练相关权限 - 训练任务 (9528)
		{Ptype: "p", V0: "9528", V1: "/modeltraining/trainingTask/createTask", V2: "POST"},
		{Ptype: "p", V0: "9528", V1: "/modeltraining/trainingTask/deleteTask", V2: "DELETE"},
		{Ptype: "p", V0: "9528", V1: "/modeltraining/trainingTask/deleteTaskByIds", V2: "DELETE"},
		{Ptype: "p", V0: "9528", V1: "/modeltraining/trainingTask/updateTask", V2: "PUT"},
		{Ptype: "p", V0: "9528", V1: "/modeltraining/trainingTask/findTask", V2: "GET"},
		{Ptype: "p", V0: "9528", V1: "/modeltraining/trainingTask/getTaskList", V2: "GET"},
		{Ptype: "p", V0: "9528", V1: "/modeltraining/trainingTask/startTask", V2: "POST"},
		{Ptype: "p", V0: "9528", V1: "/modeltraining/trainingTask/stopTask", V2: "POST"},
		{Ptype: "p", V0: "9528", V1: "/modeltraining/trainingTask/markCompleted", V2: "POST"},
		{Ptype: "p", V0: "9528", V1: "/modeltraining/trainingTask/startService", V2: "POST"},
		{Ptype: "p", V0: "9528", V1: "/modeltraining/trainingTask/stopService", V2: "POST"},
		{Ptype: "p", V0: "9528", V1: "/modeltraining/trainingTask/chatCompletion", V2: "POST"},
		{Ptype: "p", V0: "9528", V1: "/modeltraining/trainingTask/getTaskLogs", V2: "GET"},
		{Ptype: "p", V0: "9528", V1: "/modeltraining/trainingTask/getTaskDataSource", V2: "GET"},
		{Ptype: "p", V0: "9528", V1: "/modeltraining/trainingTask/getDefaultParams", V2: "GET"},

		// 模型测试历史权限 (9528)
		{Ptype: "p", V0: "9528", V1: "/modeltraining/modelTest/createTestHistory", V2: "POST"},
		{Ptype: "p", V0: "9528", V1: "/modeltraining/modelTest/deleteTestHistory", V2: "DELETE"},
		{Ptype: "p", V0: "9528", V1: "/modeltraining/modelTest/clearTestHistory", V2: "DELETE"},
		{Ptype: "p", V0: "9528", V1: "/modeltraining/modelTest/getTestHistoryList", V2: "GET"},
	}
