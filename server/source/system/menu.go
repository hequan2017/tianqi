...
func (i *initMenu) InitializeData(ctx context.Context) (next context.Context, err error) {
	...
	allMenus := []SysBaseMenu{
		...
		{MenuLevel: 0, Hidden: false, ParentId: 0, Path: "modeltraining", Name: "modeltraining", Component: "view/routerHolder.vue", Sort: 2, Meta: Meta{Title: "模型训练", Icon: "data-analysis"}},
	}
	...
	childMenus := []SysBaseMenu{
		...
		// modeltraining子菜单 - 模型训练
		{MenuLevel: 1, Hidden: false, ParentId: menuNameMap["modeltraining"], Path: "dataset", Name: "dataset", Component: "view/modeltraining/dataset/index.vue", Sort: 1, Meta: Meta{Title: "数据集管理", Icon: "folder-opened"}},
		{MenuLevel: 1, Hidden: false, ParentId: menuNameMap["modeltraining"], Path: "trainingTask", Name: "trainingTask", Component: "view/modeltraining/training/index.vue", Sort: 2, Meta: Meta{Title: "训练任务", Icon: "video-play"}},
		{MenuLevel: 1, Hidden: true, ParentId: menuNameMap["modeltraining"], Path: "createTrainingTask", Name: "createTrainingTask", Component: "view/modeltraining/training/createTask.vue", Sort: 3, Meta: Meta{Title: "创建训练任务", Icon: "plus"}},
	}
